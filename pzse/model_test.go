...
func getTestConfigList() ([6]ConfigType, [6]ConfigParseOut, string) {
	...
	configParseList[0] = ConfigParseOut{"", ":8080", "", false, nil}

	configList[1] = ConfigType{cliCmd, versionCmd, versionStr, "", authEnVar, svcName, url, 0, desc, attr, numProcs}
	configParseList[1] = ConfigParseOut{"", ":8080", "vers1\n", false, nil}

	configList[2] = ConfigType{cliCmd, versionCmd, "", pzAddr, "", "", url, port, desc, attr, numProcs}
	configParseList[2] = ConfigParseOut{"", ":8081", "vers1\n", true, nil}

	configList[3] = ConfigType{cliCmd, versionCmd, "", pzAddr, authEnVar, "", url, port, desc, attr, numProcs}
	configParseList[3] = ConfigParseOut{"pzsvc-exec", ":8081", "vers1\n", true, nil}

	configList[4] = ConfigType{cliCmd, "", versionStr, pzAddr, authEnVar, svcName, "", port, desc, attr, numProcs}
	configParseList[4] = ConfigParseOut{"pzsvc-exec", ":8081", "vers2", true, nil}

	configList[5] = ConfigType{cliCmd, "echo", "", versionStr, authEnVar, svcName, url, port, "", attr, numProcs}
